<template>
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-xl">Update Permission</h2>
...
export default {
    ...
    setup(props) {
        const names = ref(props.assaignedroles);
        ...
        function submit() {
            form.put(route('authorization.permissions.update', { permission: props.permission.id }))
        }
